...
This project handles cross-border trade, counterparty-credit and
...
- credential exposure
- real counterparty, credit or trade data exposure
- authorization bypass
- Shosha Trading Governor bypass
...
- Keep real counterparty, credit and sanctions-screening data outside this
  repository.
