# Operator Quickstart — Non-specialized wholesale trade

Shortest path from clone to a verified local dry-run for **ISIC 4690** (`cloud-itonami-isic-4690`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-4690.git
cd cloud-itonami-isic-4690
```
...
- Blueprint governor key: `shosha-trading-governor`
- Likely source path: `shosha.governor.cljc`
